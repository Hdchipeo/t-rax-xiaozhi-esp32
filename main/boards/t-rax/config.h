...
#define TOF_I2C_SDA_GPIO GPIO_NUM_8
#define TOF_I2C_SCL_GPIO GPIO_NUM_9

// DRV8833 Motor Driver Pins (Track DC Motors)
#define MOTOR_LEFT_AIN1_GPIO GPIO_NUM_1
#define MOTOR_LEFT_AIN2_GPIO GPIO_NUM_2
#define MOTOR_RIGHT_BIN1_GPIO GPIO_NUM_3
#define MOTOR_RIGHT_BIN2_GPIO GPIO_NUM_4

// Head Movement Servo Pins (PWM)
#define SERVO_PAN_PAN_GPIO GPIO_NUM_5  // Trục xoay ngang (Yaw)
#define SERVO_TILT_GPIO GPIO_NUM_6     // Trục gật lên xuống (Pitch)

// Driver Enable Pin (DRV8833 nSLEEP / Amp Enable)
#define DRIVER_ENABLE_GPIO GPIO_NUM_13
